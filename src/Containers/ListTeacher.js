...
function ListTeacherContainer() {
  ...
  const { listTeacher } = useSelector((state) => state.UserManagerReducer);
  const [arr, setArr] = useState(listTeacher);
...
export default memo(ListTeacherContainer);
